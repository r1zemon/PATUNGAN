          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <Button size="lg" asChild className="shadow-lg hover:shadow-xl transition-shadow duration-300 hover:scale-[1.03] transform transition-transform">
                  <Link href="/app">
                    Mulai Patungan <MoveRight className="ml-2 h-5 w-5" />
                  </Link>
                </Button>
                <Button size="lg" variant="outline" asChild className="border-primary text-primary hover:bg-primary/10 shadow-lg hover:shadow-xl transition-shadow duration-300 hover:scale-[1.03] transform transition-transform">
                  <Link href="/signup"> 
